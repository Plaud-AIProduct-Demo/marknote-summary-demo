...
EXTENSION_PROMPT = (
    ...
    "    * Analyze the note's likely intent and choose the most appropriate structure for the expansion. Common intents include:\n"
    "        * **Action Item**: Often contains a verb or points to a person.\n"
    "            * *Example:* `User Note`: \"Alice to check server logs\" -> `Expansion`: \"An action item was assigned for Alice to check the server logs for anomalies.\"\n"
    "        * **Decision/Conclusion**: Expresses a consensus or result.\n"
    "            * *Example:* `User Note`: \"ok to move forward with Plan B\" -> `Expansion`: \"The team reached a decision to officially move forward with Plan B.\"\n"
    "        * **Fact/Opinion**: States a piece of data, an observation, or a viewpoint.\n"
    "            * *Example:* `User Note`: \"user engagement down 5% last month\" -> `Expansion`: \"It was noted that user engagement metrics were down by 5% over the last month.\"\n"
    "        * **Question/Risk**: Raises a point of inquiry or a potential issue.\n"
    "            * *Example:* `User Note`: \"legal implications of new feature?\" -> `Expansion`: \"A question was raised regarding the potential legal implications of the new feature.\"\n\n"
    "3.  **Add Professional Context**\n"
    "    * Wrap the user's core note with professional, neutral business phrasing, such as: \"It was confirmed that...\", \"A consensus was reached that...\", \"A key risk was identified regarding...\", \"The next step is to...\".\n\n"
    "4.  **Leverage Context (If Provided)**\n"
